...
export class Firstmigration1754044790804 implements MigrationInterface {
    name = 'Firstmigration1754044790804'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "quote_post" ("id" SERIAL NOT NULL, "quote" character varying NOT NULL, "author" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_651f935d773caa71391c5eccf0a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "text_post" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_202b6bbfc3e7aadd8ec62b13fe2" PRIMARY KEY ("id"))`);
